...
<h1>Court Page Manager</h1>
<div class="menubar">
  <ul>
    <li><a href="<?=url::site('admin/courts/add')?>">New Page</a></li>
  </ul>
</div>
...
<li id="sort_<?=$page->id?>" class="list-item sortable">
  ...
  <h1><?=$page->title?></h1>
  <div class="options">
    <a class="edit-link" href="<?=url::site('admin/courts/edit/' . $page->url)?>">Edit</a>
    <a class="delete-link" href="<?=url::site('admin/courts/delete/' . $page->url)?>">Delete</a>
  </div>
