...
<div id="report-years">
  <div id="minutes">
    ...
    <h2><a href="<?=url::site('boards/redevelopment/reports/' . $year->year . '/minutes')?>"><?=$year->year?></a></h2>
    <?php endforeach; ?>
  ...
  <div id="agendas">
    ...
    <h2><a href="<?=url::site('boards/redevelopment/reports/' . $year->year . '/agendas')?>"><?=$year->year?></a></h2>
    <?php endforeach; ?>
