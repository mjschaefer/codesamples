...
<div id="report-years">
  <div id="minutes">
    ...
    <h2><a href="<?=url::site('departments/building/reports/' . $year->year . '/minutes')?>"><?=$year->year?></a></h2>
    <?php endforeach; ?>
  ...
  <div id="agendas">
    ...
    <h2><a href="<?=url::site('departments/building/reports/' . $year->year . '/agendas')?>"><?=$year->year?></a></h2>
    <?php endforeach; ?>
