...
class Boards_Controller extends Template_Controller {
  ...
  public function index()
  {
    ...
    $view = new View('board_list');
    
    $this->template->page_title = "Boards";
  ...
  public function list_pages($section)
  {
    ...
    $view = new View('board_page_list');
    $view->section = $section;
    $view->pages = $pages;
  
    $this->template->page_title = ucwords( str_replace('_', ' ', $section) ) . " Board Pages";
    $this->template->content = $view;
  }
  ...
  public function create_page()
  {
    ...
    url::redirect('admin/boards/' . $page->section . '/list/pages');
  }
  ...
  public function delete_page($section, $url)
  {
    ...
    url::redirect('admin/boards/' . $section . '/list/pages');
  }
  ...
  public function minutes($section)
  {
    ...
    $view = new View('board_minutes_list');
    $view->section = $section;
    $view->minutes = $minutes;
    
    $this->template->page_title = ucwords($section) . 'Board Minutes';
    $this->template->content = $view;
  }
  ...
  public function add_minutes($section)
  {
    ...
    $view = new View('add_board_minutes');
    $view->section = $section;
  ...
  public function create_minutes()
  {
    ...
    url::redirect('admin/boards/' . $minutes->section . '/minutes');
  }
  ...
  public function edit_minutes($section, $id)
  {
    ...
    $view = new View('edit_board_minutes');
    $view->minutes = $minutes;
    $view->section = $section;
  ...
  public function delete_minutes($section, $id)
  {
    ...
    url::redirect('admin/boards/' . $section . '/minutes');
  }
  ...
  public function agendas($section)
  {
    ...
    $view = new View('board_agendas_list');
    $view->section = $section;
    $view->agendas = $agendas;
    
    $this->template->page_title = ucwords($section) . 'Board Agendas';
    $this->template->content = $view;
  }
  ...
  public function add_agenda($section)
  {
    ...
    $view = new View('add_board_agenda');
    $view->section = $section;
  ...
  public function create_agenda()
  {
    ...
    url::redirect('admin/boards/' . $agenda->section . '/agendas');
  }
  ...
  public function edit_agenda($section, $id)
  {
    ...
    $view = new View('edit_board_agenda');
    $view->agenda = $agenda;
    $view->section = $section;
  ...
  public function delete_agenda($section, $id)
  {
    ...
    url::redirect('admin/boards/' . $section . '/agendas');
  }
