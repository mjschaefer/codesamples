<?php
	...
	$unix_day_now = mktime(0, 0, 0, date('m', $unix_date), date('d', $unix_date), date('y', $unix_date));
	$unix_day_next = mktime(0, 0, 0, date('m', $unix_date), date('d', $unix_date) + 1, date('y', $unix_date));
